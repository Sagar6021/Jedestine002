...
public class PlacingOrderTest {
	...
	@Test
	public void placingOrderTest() throws MalformedURLException {
MobileDriverUtility mLib=new MobileDriverUtility();
		...
		//Fill the Address
		driver.findElement(By.id("pincode")).sendKeys("560076");
		driver.findElement(By.id("streetAddress")).sendKeys("hgdhhjdh");
		driver.findElement(By.id("locality")).sendKeys("Banglore");
		driver.findElement(By.id("city")).sendKeys("Banglore");
		driver.findElement(By.id("state")).sendKeys("Karnatak");
		driver.findElement(By.id("addressType-home")).click();
